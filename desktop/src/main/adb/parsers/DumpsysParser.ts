// Порт Sources/AdbShell/Services/DumpsysParser.swift (parseAppDetail only —
// parseVersionCodes/F-Droid bulk-update-check path not ported yet, see
// desktop/PLAN.md). Формат `dumpsys package <pkg>` неофициальный и слегка
// отличается между версиями Android, парсер намеренно толерантен к
// отсутствующим секциям.
